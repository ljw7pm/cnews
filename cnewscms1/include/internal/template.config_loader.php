...
if (!$this->force_compile && file_exists($this->compile_dir.$this->reserved_template_varname."_".$name) && (filemtime($this->compile_dir.$this->reserved_template_varname."_".$name) > filemtime($this->config_dir.$file)))
{
	include($this->compile_dir.$this->reserved_template_varname."_".$name);
	return true;
}
